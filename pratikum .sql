...
BEGIN
    ...
    DECLARE nim VARCHAR(20) DEFAULT '2411021';
...
BEGIN
    ...
    DECLARE v_nim VARCHAR(20) DEFAULT '2411021';
    DECLARE v_ipk DECIMAL(3,2) DEFAULT 3.20;
...
BEGIN
    DECLARE nama1 VARCHAR(50) DEFAULT 'ria';
    DECLARE nim1 VARCHAR(20) DEFAULT '2411056';
    DECLARE ipk1 DECIMAL(3,2) DEFAULT 3.20;
    DECLARE sks1 INT DEFAULT 15;

    DECLARE nama2 VARCHAR(50) DEFAULT 'Hasriani';
    DECLARE nim2 VARCHAR(20) DEFAULT '2411040';
